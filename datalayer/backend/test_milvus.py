...
testCollection = MilvusBackend(host="localhost", port='19530', collection=collection, schema=schema)
metadata = {
    "globalId": 1,
    "cameraId": '192.168.1.1',
    "timeStart": convert_second_2_datetime(time()),
...
# print(image2)
data = [
    [[random.random() for _ in range(2048)] for _ in range(1)],
    [json.dumps(metadata) for _ in range(1)]
]
